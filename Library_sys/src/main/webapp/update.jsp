...
<body>
	<div class="form-container">
		...
		<form action="UpdateBookServlet" method="post">
			...
			<div class="form-group">
				<label for="title">Title of Book</label> <input type="text"
					id="title" name="title" required>
			</div>
			<div class="form-group">
				<label for="author">Author of Book</label> <input type="text"
					id="author" name="author" required>
			</div>
			<div class="form-group">
				<label for="price">Price Of Book(In Rs)</label> <input type="text"
